...
public class ExercicioC {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite os votos válido para o candidato B:");
		votosB = sc.nextInt();
		System.out.println("Digite os votos em Branco para o candidato B:");
		votosBrancoB = sc.nextInt();
		System.out.println("Digite os votos nulos para o candidato B:");
		votosNuloB = sc.nextInt();

		System.out.println("Digite os votos de votos válido para o candidato C:");
		votosC = sc.nextInt();
		System.out.println("Digite os votos de votos em Branco para o candidato C:");
		votosBrancoC = sc.nextInt();
		System.out.println("Digite os votos de votos nulo para o candidato C:");
